...
sudo -u vagrant defaults write NSGlobalDomain AppleLanguages -array 'PACKER-LOCALE-USING-HYPHEN' 'en'
sudo -u vagrant defaults write NSGlobalDomain AppleLocale 'PACKER-LOCALE-USING-UNDERSCORE'
sudo -u vagrant defaults write NSGlobalDomain NSPreferredSpellServerLanguage 'PACKER-LOCALE-USING-UNDERSCORE'
